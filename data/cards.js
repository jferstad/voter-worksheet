...
const researchedQualityCards = [
  ...
  {id:'smc-schools-bonini-transparency', office:'San Mateo County Superintendent of Schools', candidate:'Chelsea Bonini', type:'Issue/position', topic:'Office transparency', statement:'This candidate argues the County Office of Education should give its governing board and the public more insight into decisions, budgets, and program direction.', question:'How much do you value this transparency-and-oversight argument?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-bonini-board-relationship', office:'San Mateo County Superintendent of Schools', candidate:'Chelsea Bonini', type:'Issue/position', topic:'Board-office relationship', statement:'This candidate says an early priority would be repairing a strained relationship between the superintendent’s office and the elected Board of Education so board members are more involved in change-making.', question:'How important is this board-office reset to your rating?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-bonini-ai-convener', office:'San Mateo County Superintendent of Schools', candidate:'Chelsea Bonini', type:'Issue/position', topic:'AI and district convening', statement:'On classroom AI, this candidate says the county office should act as a convener so districts approach the issue with shared intent, care, empathy, and education.', question:'How much does this AI convening role matter for county schools?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-cross-department', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Issue/position', topic:'Cross-department student support', statement:'This candidate argues the county office should treat connected issues such as safety, inclusion, transportation, and student services as one coordinated system rather than isolated programs.', question:'How much do you value this systems approach?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-practitioner', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Record/experience', topic:'Program implementation', statement:'This candidate contrasts hands-on Office of Education practitioner experience with board service, emphasizing creating programs, bringing people on board, implementing them, and adjusting from results.', question:'How much does implementation experience matter here?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-coalitions', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Issue/position', topic:'Countywide education coalitions', statement:'This candidate says sustaining public schools requires countywide coalitions that activate time, people, and money around what is best for children.', question:'How much do you value this coalition-building approach?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-district-outreach', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Issue/position', topic:'Proactive district outreach', statement:'This candidate wants the county office to move beyond asking districts to “come to us” for services and instead reach districts that are isolated, under-resourced, or unsure the office understands their needs.', question:'How important is this proactive district-outreach model?', sources:['smDailyJournalSchools']},

...
const researchedQualityCards = [
  ...
  {id:'smc-schools-bonini-transparency', office:'San Mateo County Superintendent of Schools', candidate:'Chelsea Bonini', type:'Issue/position', topic:'Office transparency', statement:'Local reporting says Bonini wants more transparency between the County Office of Education, its governing board, and the public.', question:'How much do you value this transparency argument?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-bonini-board-relationship', office:'San Mateo County Superintendent of Schools', candidate:'Chelsea Bonini', type:'Issue/position', topic:'Board-office relationship', statement:'She says her early focus would be improving the working relationship between the County Office of Education and the Board of Education.', question:'How important is board-office governance to your rating?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-bonini-ai-convener', office:'San Mateo County Superintendent of Schools', candidate:'Chelsea Bonini', type:'Issue/position', topic:'AI in schools', statement:'On classroom AI, Bonini says the county office should convene schools so they approach the issue with shared intent, care, empathy, and education.', question:'How much does this AI convening role matter for county schools?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-cross-department', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Issue/position', topic:'Cross-department student support', statement:'Camacho argues the county office should treat connected issues such as safety, inclusion, transportation, and student services as one coordinated whole rather than isolated pieces.', question:'How much do you value this systems approach?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-practitioner', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Record/experience', topic:'Program implementation', statement:'He contrasts his Office of Education practitioner role with board service, emphasizing experience creating programs, bringing people on board, implementing them, and adjusting from results.', question:'How much does implementation experience matter here?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-coalitions', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Issue/position', topic:'Countywide education coalitions', statement:'He says sustaining public schools requires building countywide coalitions that activate time, people, and money around what is best for children.', question:'How much do you value this coalition-building approach?', sources:['smDailyJournalSchools']},
  {id:'smc-schools-camacho-student-safety', office:'San Mateo County Superintendent of Schools', candidate:'Héctor Camacho Jr.', type:'Issue/position', topic:'Student safety and inclusion', statement:'Local reporting says his recent Office of Education work shifted toward student safety and well-being amid concerns about immigration enforcement and LGBTQIA+ youth protections.', question:'How much does this student-safety focus matter?', sources:['smDailyJournalSchools']},

  {id:'smc-d3-mueller-crisp-projects', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Record/experience', topic:'Coastside infrastructure resilience', statement:'Local reporting and the county page point to the Coastside Resilient Infrastructure Strategic Plan, a list of more than 100 critical projects for coastal protections and resilience.', question:'How much does this resilience-infrastructure record matter?', sources:['smDailyJournalD3','smcMuellerPriorities']},
  {id:'smc-d3-mueller-farmworker-housing', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Issue/position', topic:'Farmworker housing safety', statement:'He says a next-term focus would be bringing farmworker housing up to code after the county identified unsafe living conditions following the 2023 Half Moon Bay mass shooting.', question:'How important is farmworker-housing enforcement to you?', sources:['smDailyJournalD3']},
  {id:'smc-d3-mueller-coastside-healthcare', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Record/experience', topic:'Coastside urgent care', statement:'The county page credits him with helping establish a Coastside urgent-care option after the area lost its only emergency room.', question:'How much does this healthcare-access record matter?', sources:['smcMuellerPriorities']},
  {id:'smc-d3-mueller-labor-ai', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Record/experience', topic:'Labor standards and AI worker protection', statement:'The county page credits him with co-sponsoring a labor-standards enforcement office and initiating an AI worker-protection policy for county employees.', question:'How much do labor enforcement and AI worker rules matter for this office?', sources:['smcMuellerPriorities']},
  {id:'smc-d3-jimenez-ag-economy', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jiménez', type:'Issue/position', topic:'Coastside agriculture economy', statement:'Local reporting says Jiménez wants to grow farming and ranching on the Coastside, including ideas such as a coast dairy farm and more economic support for agriculture.', question:'How much do you value this agriculture-economy focus?', sources:['smDailyJournalD3']},
  {id:'smc-d3-jimenez-vocational-union-pathways', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jiménez', type:'Issue/position', topic:'Vocational and union pathways', statement:'He wants programs that give high school students vocational training and pathways into union work.', question:'How much do vocational and union pathways matter to you?', sources:['smDailyJournalD3']},
  {id:'smc-d3-jimenez-coastside-transit', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jiménez', type:'Issue/position', topic:'Coastside transportation', statement:'He says better public transportation to and from the Coastside is critical because State Route 92 is the only major route in and out of the area.', question:'How important is Coastside transit in your supervisor rating?', sources:['smDailyJournalD3']},
  {id:'smc-d3-jimenez-sheriff-removal-process', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jiménez', type:'Issue/position', topic:'Sheriff removal governance', statement:'In the sheriff-removal dispute, Jiménez argued the county should have used a recall rather than spending heavily on removing the elected sheriff through the board process.', question:'How much does this governance stance matter to you?', sources:['smDailyJournalD3']},

  {id:'smc-assessor-canepa-deputy-reorg', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'David Canepa', type:'Issue/position', topic:'Department reorganization', statement:'Local reporting says Canepa would reorganize the 167-employee office so each major department has a deputy at the top.', question:'How much do you value this reorganization plan?', sources:['paDailyPostAssessor']},
  {id:'smc-assessor-canepa-morale-promotion', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'David Canepa', type:'Issue/position', topic:'Employee morale and promotion', statement:'He says he would improve employee morale and promote from within after concerns about office trust and workplace conditions.', question:'How important is internal morale reform for this office?', sources:['paDailyPostAssessor']},
  {id:'smc-assessor-canepa-audit', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'David Canepa', type:'Issue/position', topic:'Performance audit', statement:'If elected, he says he would conduct a financial and performance audit to understand the office problems he is inheriting.', question:'How much do you value an early audit of the office?', sources:['paDailyPostAssessor']},
  {id:'smc-assessor-canepa-resident-service', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'David Canepa', type:'Issue/position', topic:'Resident service and outreach', statement:'He says residents should get hands-on help with ballots, ownership changes, and records, not just be directed to a website, and he wants more public education through social media.', question:'How much do you value this hands-on customer-service approach?', sources:['paDailyPostAssessor','canepaCampaign']},
  {id:'smc-assessor-irizarry-vote-by-mail', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'Jim Irizarry', type:'Record/experience', topic:'Vote-by-mail implementation', statement:'Local reporting says Irizarry helped create San Mateo County vote-by-mail systems and argues every voter is verified in that model.', question:'How much does this election-administration record matter?', sources:['paDailyPostAssessor']},
  {id:'smc-assessor-irizarry-recount-accuracy', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'Jim Irizarry', type:'Record/experience', topic:'Recount accuracy', statement:'He cites the 2024 Low-Simitian recount as evidence of office accuracy, saying the certified vote matched the recount.', question:'How much does this recount-management example matter?', sources:['paDailyPostAssessor']},
  {id:'smc-assessor-irizarry-vacancies-training', office:'San Mateo County Assessor-County Clerk-Recorder', candidate:'Jim Irizarry', type:'Issue/position', topic:'Vacancies and internal growth', statement:'His first priority would be filling department vacancies while promoting from within and keeping the organization improving over time.', question:'How much do you value this continuity-and-staffing plan?', sources:['paDailyPostAssessor']}
];
...
const localRaceExpansionCards = [
  {id:'ad21-papan-rhna-reform', office:'State Assembly, District 21', candidate:'Diane Papan', type:'Issue/position', topic:'Housing mandates and RHNA reform', statement:'Local reporting says Papan wants to keep reforming state housing mandates, including the regional housing needs allocation process and how local housing targets are calculated.', question:'How much do you support this housing-mandate reform approach?', sources:['smDailyJournalAD21','leginfoPapanAB650']},
  {id:'ad21-papan-rental-assistance', office:'State Assembly, District 21', candidate:'Diane Papan', type:'Issue/position', topic:'Rental assistance and homelessness prevention', statement:'The Daily Journal reported that Papan sees rental assistance as a way to keep people housed during hard periods and prevent them from falling into homelessness.', question:'How much do you value rental assistance as a homelessness-prevention tool?', sources:['smDailyJournalAD21']},
  {id:'ad21-papan-public-education', office:'State Assembly, District 21', candidate:'Diane Papan', type:'Issue/position', topic:'Public schools', statement:'A legislative profile describes Papan as prioritizing affordable housing and access to quality public schools as part of her Assembly work.', question:'How important is this public-schools priority to your AD21 rating?', sources:['papanLegProfile']},
  {id:'ad21-papan-progressive-housing-record', office:'State Assembly, District 21', candidate:'Diane Papan', type:'Record/experience', topic:'Tenant and social-housing votes', statement:'The Progressive Voters Guide gives Papan a generally high progressive score but flags that she did not vote for some tenant-protection and social-housing bills.', question:'How much does this housing-legislation record affect your view of Papan?', sources:['progressivePapanGuide']},
  {id:'ad21-papan-transit-infrastructure-record', office:'State Assembly, District 21', candidate:'Diane Papan', type:'Record/experience', topic:'Transit and infrastructure', statement:'A legislative profile says that before joining the Assembly, Papan was a San Mateo city leader who championed infrastructure, transit, and climate-adaptation investment.', question:'How much does this local transit-and-infrastructure record matter?', sources:['papanLegProfile']},

  {id:'ad21-muhawieh-tax-affordability', office:'State Assembly, District 21', candidate:'Jabra J. Muhawieh', type:'Issue/position', topic:'Taxes and affordability', statement:'Local reporting describes Muhawieh, a licensed tax professional, as emphasizing how California taxes affect working families and small businesses.', question:'How much do you agree with this tax-and-affordability focus?', sources:['smDailyJournalAD21','sfchronBayArea2026']},
  {id:'ad21-muhawieh-housing-mandates', office:'State Assembly, District 21', candidate:'Jabra J. Muhawieh', type:'Issue/position', topic:'State housing mandates', statement:'The Daily Journal reported that Muhawieh is not supportive of state housing mandates, though he said state guidelines could still help cities plan for needed housing.', question:'How much do you agree with this limits-on-mandates approach?', sources:['smDailyJournalAD21']},
  {id:'ad21-muhawieh-targeted-affordable-housing', office:'State Assembly, District 21', candidate:'Jabra J. Muhawieh', type:'Issue/position', topic:'Targeted affordable housing', statement:'He told the Daily Journal that affordable housing could be concentrated in major cities and could also be built for specific career-based groups, such as teachers or other workers.', question:'How much do you support this targeted affordable-housing approach?', sources:['smDailyJournalAD21']},
  {id:'ad21-muhawieh-ai-workforce-education', office:'State Assembly, District 21', candidate:'Jabra J. Muhawieh', type:'Issue/position', topic:'AI and workforce skills', statement:'Local reporting says Muhawieh wants Californians to learn how to work with artificial intelligence while also supporting some safety regulation.', question:'How important is AI workforce preparation in your AD21 rating?', sources:['smDailyJournalAD21']},

  {id:'smc-controller-raigoza-tenure', office:'San Mateo County Controller', candidate:'Juan Raigoza', type:'Record/experience', topic:'County finance career', statement:'County materials say Raigoza has served as San Mateo County Controller since 2015 after earlier roles as senior internal auditor, division manager, and assistant controller.', question:'How much does this county-finance career path matter?', sources:['smcControllerRaigoza','sfchronBayArea2026']},
  {id:'smc-controller-raigoza-financial-reporting', office:'San Mateo County Controller', candidate:'Juan Raigoza', type:'Record/experience', topic:'Financial reporting awards', statement:'The Controller profile says the county annual comprehensive financial report has repeatedly earned national financial-reporting recognition under Raigoza’s tenure.', question:'How much does this financial-reporting record matter for Controller?', sources:['smcControllerRaigoza','smcControllerGfoa']},
  {id:'smc-controller-raigoza-operations-controls', office:'San Mateo County Controller', candidate:'Juan Raigoza', type:'Record/experience', topic:'Auditing and internal controls', statement:'County materials say Raigoza’s expertise in governmental accounting, auditing, information systems, and internal controls helps him assess county operations and recommend improvements.', question:'How much does this operations-and-controls background matter?', sources:['smcControllerRaigoza']},
  ...
  {id:'smc-treasurer-arnott-financial-assets', office:'San Mateo County Treasurer-Tax Collector', candidate:'Sandie Arnott', type:'Issue/position', topic:'County funds and property-tax collection', statement:'County materials describe the Treasurer-Tax Collector as managing and protecting county financial assets while collecting property taxes and administering the county treasury.', question:'How much does this funds-and-tax role matter to you?', sources:['smcTaxArnott','sfchronBayArea2026']},
  {id:'smc-treasurer-arnott-payment-modernization', office:'San Mateo County Treasurer-Tax Collector', candidate:'Sandie Arnott', type:'Record/experience', topic:'Payment access and customer service', statement:'A professional profile says Arnott focused on more convenient, efficient, and paper-light payment processes and received a county customer-service award for adding a chat line and mobile mailbox.', question:'How much do payment-access and customer-service changes matter?', sources:['nacctfoArnott']},
  {id:'smc-treasurer-arnott-taxpayer-legislation', office:'San Mateo County Treasurer-Tax Collector', candidate:'Sandie Arnott', type:'Record/experience', topic:'Taxpayer legislation and pandemic waivers', statement:'Her professional profile says she authored taxpayer-related state legislation and helped seek pandemic penalty-waiver authority for affected taxpayers.', question:'How much does this taxpayer-legislation record matter?', sources:['nacctfoArnott']}
];

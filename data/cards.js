...
const researchedQualityCards = [
  ...
  {id:'smc-d3-mueller-sheriff-removal', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Record/experience', topic:'Sheriff accountability action', statement:'This candidate supported using the county’s new charter authority to remove the elected sheriff after misconduct findings, then held community meetings with the appointed replacement to stabilize the department.', question:'How much do you support this sheriff-accountability approach?', sources:['almanacD3Current','localNewsMattersD3']},
  {id:'smc-d3-mueller-sales-tax-caution', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Issue/position', topic:'Sales-tax caution', statement:'During county funding pressure, this candidate did not support studying a sales-tax increase, while the opposing candidate said a temporary tax could be acceptable after savings are exhausted.', question:'How much do you agree with this cautious stance on a sales-tax increase?', sources:['almanacD3Current']},
  {id:'smc-d3-mueller-coastside-service-record', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Record/experience', topic:'Specific Coastside service wins', statement:'In response to claims that the Coastside lacks representation, this candidate points to farmworker-housing inspections, protection of rural landlines, clean-water approval for Pescadero schools, and a pilot urgent-care clinic after the local emergency room closed.', question:'How much do these specific Coastside service actions matter to you?', sources:['localNewsMattersD3','smcMuellerPriorities','muellerCampaign']},
  {id:'smc-d3-mueller-public-safety-enforcement', office:'San Mateo County Board of Supervisors, District 3', candidate:'Ray Mueller', type:'Issue/position', topic:'Public-safety enforcement', statement:'This candidate emphasizes enforcement-oriented public safety tools, including a residential burglary reward program, sheriff-deputy retention incentives, human-trafficking enforcement funding, and a county kratom-sale ban proposal.', question:'How much do you support this enforcement-focused public-safety agenda?', sources:['kqedD3Guide','smcMuellerPriorities','muellerCampaign','localNewsMattersD3']},

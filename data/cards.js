...
const researchedQualityCards = [
  ...
  {id:'smc-d3-jimenez-ag-economy', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jimenez', type:'Issue/position', topic:'Coastside agriculture economy', statement:'Local reporting says Jimenez wants to grow farming and ranching on the Coastside, including ideas such as a coast dairy farm and more economic support for agriculture.', question:'How much do you value this agriculture-economy focus?', sources:['smDailyJournalD3']},
  {id:'smc-d3-jimenez-vocational-union-pathways', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jimenez', type:'Issue/position', topic:'Vocational and union pathways', statement:'He wants programs that give high school students vocational training and pathways into union work.', question:'How much do vocational and union pathways matter to you?', sources:['smDailyJournalD3']},
  {id:'smc-d3-jimenez-coastside-transit', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jimenez', type:'Issue/position', topic:'Coastside transportation', statement:'He says better public transportation to and from the Coastside is critical because State Route 92 is the only major route in and out of the area.', question:'How important is Coastside transit in your supervisor rating?', sources:['smDailyJournalD3']},
  {id:'smc-d3-jimenez-sheriff-removal-process', office:'San Mateo County Board of Supervisors, District 3', candidate:'Joaquin Jimenez', type:'Issue/position', topic:'Sheriff removal governance', statement:'In the sheriff-removal dispute, Jimenez argued the county should have used a recall rather than spending heavily on removing the elected sheriff through the board process.', question:'How much does this governance stance matter to you?', sources:['smDailyJournalD3']},
